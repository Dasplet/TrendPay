...
export default function NotFound() {
  return (
    <main className="min-h-screen tp-login-bg flex items-center justify-center p-5">
      <div className="w-full max-w-sm text-center">
        <div className="tp-login-card rounded-3xl p-8">
          ...
          <div className="text-5xl font-black text-[var(--tp-text)] tracking-tight mb-2">404</div>
          <div className="text-base font-semibold text-[var(--tp-text)] mb-1">Página no encontrada</div>
          <p className="text-sm text-[var(--tp-muted)] mb-6">
